<template>
  <div class="app-container">
    ...
    <div slot="footer"
      ...
      <el-button @click="cancelBtn">返回积分商品管理</el-button>
    </div>
...
import { pointProductInfo } from '@/api/point_market';
import { prodCheck, prodOnOff } from '@/api/prods';
...
export default {
  ...
  methods: {
    ...
    cancelBtn() {
      this.$router.push('/point_prods/point_manage');
    }
  },
  created() {
